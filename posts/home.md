...
For those who are new to [WebAssembly](http://webassembly.org) and [Rust](https://www.rust-lang.org/en-US/), follow the following tutorial of how to get WebAssembly and Rust working happily together!
...
We will be using the latest features of Rust language, so default the nightly toolchain, and also install the wasm64-unknown-unknown toolchain as well:
...
The bundle should now be served at http://localhost:8000

Thanks for following along! 

The repo for this project is at: https://github.com/BrantleighBunting/wasm-sandbox
